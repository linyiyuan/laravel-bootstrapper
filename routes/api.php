...
// ================== 不需要Token认证权限的路由 ==================
        ...
        Route::group(['prefix' => 'common', 'namespace' => 'Common'], function() {
            ...
            Route::get('get_verification_code', 'ConfigController@getVerificationCode');    //获取图形验证码
        });
...
// ================== 需要Token认证的接口路由 ==================
        Route::middleware(['refresh.token'])->group(function(){
            ...
            Route::middleware(['check.permission','record.operate'])->group(function(){
                //设置模块
                Route::group(['prefix' => 'admin_data', 'namespace' => 'AdminData'] ,function(){
                    //后台登录相关接口
                    Route::group(['prefix' => 'delivery', 'namespace' => 'Delivery'] ,function(){
                        Route::resource('delivery_user', 'DeliveryUserController');
                        Route::resource('delivery_user_group', 'DeliveryUserGroupController');
                    });
                });
                ...
                Route::group(['prefix' => 'setting'] ,function(){
                    ...
                    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'] ,function(){
                        ...
                        Route::resource('data_permission', 'DataPermissionController');                             //数据权限控制器
                        ...
                        Route::post('give_role_data_permission', 'PermissionAccordController@giveRoleDataPermission');   //分配数据权限给角色
                        Route::post('give_user_permission', 'LoginController@giveUserPermission');                       //分配权限给用户
                    });
